...
fn verify_signature_header(signature: String, secret: String, body: &Vec<u8>, parsed_body: String) -> Result<(), HttpResponse> {
...
fn generate_signature_sha1(secret_bytes: &Vec<u8>, body: &Vec<u8>) -> Hmac<Sha1> {
    let digest = Sha1::new();
